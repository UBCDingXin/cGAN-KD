...
def parse_arguments():
    ...
    parser.add_argument("--real_data", default="/home/xin/OneDrive/Working_directory/GAN-based_KD/CIFAR/cGAN-based_KD/data/CIFAR10_trainset_50000_seed_2020.h5", type=str)
    parser.add_argument("--fake_data", default="None", type=str)
    parser.add_argument("--num_workers", default=8, type=int)
    parser.add_argument("--nfake", default=1e30, type=float)
    parser.add_argument("--ta_name", default="vgg13", type=str, help="TA for TAKD")
...
def start_evaluation(args):
    ...
    train_loader, test_loader = get_cifar(num_classes=num_classes, real_data=args.real_data, fake_data=args.fake_data, nfake=args.nfake, batch_size=args.batch_size, num_workers=args.num_workers)
