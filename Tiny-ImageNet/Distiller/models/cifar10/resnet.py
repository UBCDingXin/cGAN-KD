...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=200):
        ...
        self.layer1 = self._make_layer(block, 64, num_blocks[0], stride=2)  ## change for 64x64. stride from 1 to 2
...
class ResNetSmall(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(3, 64, kernel_size=3,
                               stride=1, padding=1, bias=False)
        self.bn1 = nn.BatchNorm2d(64)
        self.layer1 = self._make_layer(block, 16, num_blocks[0], stride=2) ## change for 64x64
