...
2>&1 | tee output_takd_${teacher_net}+${TA_net}+${student_net}_TAlambda_${assistant_lambda_kd}_TAT_${assistant_t_kd}_Stulambda_${student_lambda_kd}_StuT_${student_t_kd}_nfake_${NFAKE}.txt
