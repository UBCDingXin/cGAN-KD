...
def cnn_opts():
    ...
    parser.add_argument('--num_classes', type=int, default=200, metavar='N')
...
def gen_synth_data_opts():
    ...
    ''' GAN Settings '''
    parser.add_argument('--gan_dim_g', type=int, default=120)
...
def blkd_opts():
    ...
    parser.add_argument('--T_kd', type=int, default=5)
...
def takd_opts():
    ...
    parser.add_argument('--assistant_T_kd', type=int, default=5)

    parser.add_argument('--student_lambda_kd', type=float, default=0.5)
    parser.add_argument('--student_T_kd', type=int, default=5)
