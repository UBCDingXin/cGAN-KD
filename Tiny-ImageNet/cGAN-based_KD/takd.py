...
''' Dump test results '''
test_results_logging_fullpath = args.root_path + '/output/Test_results_TAKD_student_{}_teacher_{}_TA_{}_seed_{}_data_{}.txt'.format(args.student, args.teacher, args.teacher_assistant, args.seed, train_dataset_name)
