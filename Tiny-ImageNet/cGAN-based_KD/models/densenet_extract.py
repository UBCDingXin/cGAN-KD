...
class DenseNet_extract(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=200, nc=NC, img_height=IMG_SIZE, img_width=IMG_SIZE):
