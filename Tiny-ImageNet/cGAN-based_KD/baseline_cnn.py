...
subtrain_indx = hf['indx_subtrain'][:]
subvalid_indx = hf['indx_subvalid'][:]
hf.close()
...
test_results_logging_fullpath = args.root_path + '/output/Test_results_baseline_{}_seed_{}_data_{}_validation_{}.txt'.format(args.cnn_name, args.seed, train_dataset_name, args.validaiton_mode)
