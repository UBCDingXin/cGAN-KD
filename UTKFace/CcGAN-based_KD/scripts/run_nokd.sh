...
--root_path $ROOT_PATH --data_path $REAL_DATA_PATH --fake_dataset_name $FAKE_DATASET_NAME \
...
--weight_decay 1e-4 \
2>&1 | tee output_baseline_${CNN_NAME}_fake_${FAKE_DATASET_NAME}_seed_${SEED}.txt
