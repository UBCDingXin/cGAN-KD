...
class SAGAN_Discriminator(nn.Module):
    ...
    def __init__(self, nc=3, disc_ch=128, dim_embed=128):
        ...
        self.snlinear1 = snlinear(in_features=disc_ch*16, out_features=1)
        self.sn_embedding1 = snlinear(dim_embed, disc_ch*16, bias=False)
    ...
    def forward(self, x, labels):
        ...
        out = torch.sum(out, dim=[2,3])   # n x disc_ch*16
