...
FAKE_DATA_PATH="${ROOT_PATH}/output/fake_data/utkface_fake_images_SAGAN_cDR-RS_presae_epochs_200_DR_MLP5_epochs_200_lambda_0.010_filter_vgg11_perc_0.90_adjust_False_NFakePerLabel_2000_seed_2020.h5"
NFAKE=60000
...
python baseline_cnn.py \
    ...
    2>&1 | tee output_ablation1-3_${ARCH}_nfake_${NFAKE}.txt
