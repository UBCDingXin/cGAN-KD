...
FAKE_DATA_PATH="${ROOT_PATH}/output/fake_data/steeringangle_fake_images_SAGAN_cDR-RS_presae_epochs_200_DR_MLP5_epochs_200_lambda_0.010_filter_vgg19_perc_0.70_adjust_True_Nlabel_2000_NFakePerLabel_50_seed_2020.h5"
NFAKE=50000
...
python baseline_cnn.py \
    ...
    2>&1 | tee output_ablation1-6_${ARCH}_nfake_${NFAKE}.txt
