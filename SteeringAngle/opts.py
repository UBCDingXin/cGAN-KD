...
def gen_synth_data_opts():
    ...
    parser.add_argument('--gan_batch_size_disc', type=int, default=256)
    parser.add_argument('--gan_batch_size_gene', type=int, default=256)
    ...
    parser.add_argument('--samp_batch_size', type=int, default=200) #also used for computing density ratios after the dre training
    parser.add_argument('--samp_burnin_size', type=int, default=200)
    parser.add_argument('--samp_num_fake_labels', type=int, default=2000)
    parser.add_argument('--samp_nfake_per_label', type=int, default=50)
