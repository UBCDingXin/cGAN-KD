...
ROOT_PATH="./ImageNet-100/make_fake_datasets"
DATA_PATH="./datasets/ImageNet-100"
EVAL_PATH="./ImageNet-100/eval_and_gan_ckpts/ckpt_PreCNNForEval_InceptionV3_epoch_200_SEED_2021_Transformation_True.pth"
...
PRECNN_NET="densenet161"
PRECNN_CKPT_PATH="./ImageNet-100/RepDistiller/output/teacher_models/vanilla/ckpt_${PRECNN_NET}_epoch_240_last.pth"
