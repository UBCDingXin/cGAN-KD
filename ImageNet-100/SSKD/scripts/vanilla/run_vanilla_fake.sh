...
FAKE_DATA_PATH="./ImageNet-100/make_fake_datasets/fake_data/cifar100_fake_images_BigGAN_sampling_cDR-RS_precnn_ResNet34_lambda_0.000_DR_MLP5_lambda_0.010_filter_densenet121_perc_0.90_adjust_True_NfakePerClass_5000_seed_2021.h5"
NFAKE=100000

ARCH="wrn_40_2"
INIT_PATH="./ImageNet-100/SSKD/output/teachers/vanilla/ckpt_${ARCH}_epoch_240_last.pth"
python teacher.py \
