...
''' Dump test results '''
test_results_logging_fullpath = args.root_path + '/Output_CIFAR{}/Test_results_BLKD_student_{}_teacher_{}_seed_{}_data_{}.txt'.format(args.num_classes, args.student, args.teacher, args.seed, train_dataset_name)
