...
## for real+fake
FAKE_DATASET_NAME="BigGAN_vanilla_epochs_2000_transform_True_subsampling_True_FilterCEPct_0.9_nfake_450000" ## Format: GANNAME_..._nfake_xxx; Strings between GAN name and nfake value.; do not include seed
CNN_EPOCHS=350
LR_BASE=0.1
