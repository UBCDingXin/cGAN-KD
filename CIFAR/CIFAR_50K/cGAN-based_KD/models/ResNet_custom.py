...
### Customized ###
def ResNet8_custom(num_classes=10):
    return ResNet_custom(BasicBlock, [1,1,1], num_classes=num_classes)
def ResNet20_custom(num_classes=10):
    return ResNet_custom(BasicBlock, [3,3,3], num_classes=num_classes)
def ResNet110_custom(num_classes=10):
    return ResNet_custom(BasicBlock, [18,18,18], num_classes=num_classes)
...
if __name__ == "__main__":
    net = ResNet110_custom(num_classes=10).cuda()
