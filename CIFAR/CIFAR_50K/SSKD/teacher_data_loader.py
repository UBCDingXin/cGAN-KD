...
def get_cifar(num_classes=10, real_data="", fake_data="None", nfake=1e30, batch_size=128, num_workers=4):
    ...
    if num_classes == 10:
        cifar_testset = torchvision.datasets.CIFAR10(root = os.path.dirname(real_data), train=False, download=True)
    elif num_classes == 100:
        cifar_testset = torchvision.datasets.CIFAR100(root = os.path.dirname(real_data), train=False, download=True)
