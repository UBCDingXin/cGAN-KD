...
--samp_batch_size 1000 \
--samp_num_fake_labels $NUM_FAKE_LABELS --samp_nfake_per_label $NFAKE_PER_LABEL \
--samp_filter_precnn_net VGG16 --samp_filter_precnn_net_ckpt_filename ckpt_baseline_VGG16_epoch_350_seed_2020_data_real_nreal_11250_fake_None_validation_False.pth \
--samp_filter_mae_percentile_threshold $filtering_threshold --unfiltered_fake_dataset_filename fake_RC49_NTrainPerLabel_25_SNGAN_hinge_niters_30000_subsampling_None_FilterMAEPct_1.0_nfake_179800_seed_2020.h5 \
...
--samp_num_fake_labels $NUM_FAKE_LABELS --samp_nfake_per_label $NFAKE_PER_LABEL \
--samp_filter_precnn_net VGG16 --samp_filter_precnn_net_ckpt_filename ckpt_baseline_VGG16_epoch_350_seed_2020_data_real_nreal_11250_fake_None_validation_False.pth \
--samp_filter_mae_percentile_threshold $filtering_threshold --unfiltered_fake_dataset_filename fake_RC49_NTrainPerLabel_25_SNGAN_hinge_niters_30000_subsampling_cDRE-F-SP+RS_hard_1e-20_FilterMAEPct_1.0_nfake_179800_seed_2020.h5 \
