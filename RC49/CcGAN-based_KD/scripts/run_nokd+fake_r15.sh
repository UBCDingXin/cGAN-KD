...
###=====================================================================================================================
FAKE_DATASET_NAME="SNGAN_hinge_niters_30000_subsampling_cDRE-F-SP+RS_hard_1e-20_FilterMAEPct_0.8_AdjustLabel_True_nfake_143840"
...
--weight_decay 1e-4 \
2>&1 | tee output_baseline_${CNN_NAME}_real_NTrainPerLabel_${NTRAIN_PER_LABEL}_fake_${FAKE_DATASET_NAME}_EffectiveNfake_${NFAKE}_seed_${SEED}.txt
