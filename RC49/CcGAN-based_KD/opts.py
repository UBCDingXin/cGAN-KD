...
def cnn_opts():
    ...
    parser.add_argument('--save_freq', type=str, default='50_100_150_200')
    parser.add_argument('--batch_size_train', type=int, default=128)
    parser.add_argument('--batch_size_test', type=int, default=128)
    parser.add_argument('--lr_base', type=float, default=0.01, help='base learning rate of CNNs')
    parser.add_argument('--lr_decay_factor', type=float, default=0.1)
    parser.add_argument('--lr_decay_epochs', type=str, default='60_120', help='decay lr at which epoch; separate by _')
...
def gen_synth_data_opts():
    ...
    parser.add_argument('--gan_niters', type=int, default=30000, help='number of iterations')
    ...
    parser.add_argument('--gan_batch_size_disc', type=int, default=64)
    parser.add_argument('--gan_batch_size_gene', type=int, default=64)
    ...
    parser.add_argument('--gan_threshold_type', type=str, default='hard', choices=['soft', 'hard'])
    ...
    ''' Evaluation setting ''' ## filtered fake images are not evaluated
    parser.add_argument('--eval', action='store_true', default=False)
    parser.add_argument('--eval_batch_size', type=int, default=1000)
    parser.add_argument('--eval_nfake_per_label', type=int, default=200)
    parser.add_argument('--eval_nreal_per_label', type=int, default=-1)
    parser.add_argument('--eval_epoch_FID_CNN', type=int, default=200)
    parser.add_argument('--eval_FID_radius', type=float, default=0)
    parser.add_argument('--eval_FID_num_centers', type=int, default=-1)
    parser.add_argument('--eval_dump_fake_for_NIQE', action='store_true', default=False)
    parser.add_argument('--eval_visualize_fake_images', action='store_true', default=False)
